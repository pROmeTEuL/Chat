...
DB_CONTAINER_NAME="chat-moment-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=chat-moment -d -p 5432:5432 docker.io/postgres
